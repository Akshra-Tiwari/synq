  ...
  return (
    <div className="space-y-8 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Detailed platform metrics and trends.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
          <h3 className="text-sm font-semibold text-slate-200 mb-1">User signups — 14 day trend</h3>
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
          <h3 className="text-sm font-semibold text-slate-200 mb-1">Posts — 14 day trend</h3>
          <p className="text-xs text-slate-600 mb-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 text-center">
          <p className="text-3xl font-bold text-indigo-400">{overview.verificationRate}%</p>
          <p className="text-xs text-slate-500 mt-1">Verification rate</p>
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Open to work</p>
          <p className="text-xs text-slate-700 mt-0.5">
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">Posts per user</p>
          <p className="text-xs text-slate-700 mt-0.5">Platform engagement</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
          <h3 className="text-sm font-semibold text-slate-200 mb-4">Top 10 skills</h3>
          <HorizontalBarChart
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
          <h3 className="text-sm font-semibold text-slate-200 mb-4">Top 10 tech stack</h3>
          <HorizontalBarChart
      ...
      <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5">
        <h3 className="text-sm font-semibold text-slate-200 mb-4">Availability distribution</h3>
          ...
          {availabilityDist.map(({ availability, count }) => {
            ...
            return (
              <div key={availability}
                className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.05] space-y-2">
                <p className="text-xl font-bold text-slate-100">{count}</p>
                <p className="text-xs text-slate-500 capitalize">{availability?.replace(/-/g, ' ')}</p>
                ...
                <p className="text-[10px] text-slate-700">{pct}% of users</p>
              </div>
            );
          })}
        </div>
